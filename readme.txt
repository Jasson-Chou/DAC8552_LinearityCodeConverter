...
[outputlimit]
daccoderange=513:64741 # 輸出 digital code 的最小值:最大值(注意:value所友值都會加上dac code min value)
...
2. **執行程式**  
打開終端機 (命令提示字元、PowerShell、Anaconda Prompt 皆可)或執行run_script.bat，執行：
